...
const defaultEvents = [{
    ...
    id: 3,
    start: '2022-04-24T18:00',
    end: '2022-04-24T22:00',
    title: 'Dexter BD',
    description: '',
    allDay: false,
    free: true,
    ...
    id: 4,
    start: '2022-04-26T10:30',
    end: '2022-04-26T11:30',
...
const colors = ['rgba(255, 236, 61, 0.80)', 'rgba(255, 153, 0, 0.80)', 'rgba(245, 69, 56, 0.80)', 'rgba(234, 30, 99, 0.80)', 'rgba(156, 38, 176, 0.80)', 'rgba(63, 81, 181, 0.80)', '', 'rgba(0, 151, 136, 0.80)', 'rgba(75, 175, 79, 0.80)', 'rgba(126, 93, 78, 0.80)'];
